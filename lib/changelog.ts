...
export const CHANGELOG: ChangelogEntry[] = [
  {
    version: "1.4.1",
    date: "2026-08-09",
    title: "角色主动发好友申请：聊天里角色能主动加你为好友",
    highlights: [
      "补齐「角色自主社交」最后一环：角色在日常 1:1 聊天里输出 [加好友 | 备注: 想认识你] / [申请加好友 | 理由: 多聊聊天] / [添加好友] 等标签，即向你发起好友申请",
      "申请自动进入通讯录「新的朋友」并点亮红点（与「被删后挽留」共用同一套申请/红点机制）；聊天里弹出 toast 并留一条系统消息记录「X 向你发起了好友申请」",
      "智能去重：已是联系人或已有待处理申请时不重复建申请；已是联系人时改为发一句友好的「想和你更亲近一点~」系统消息，避免冗余弹窗",
      "你从「新的朋友」里接受即通过申请、把 TA 加回通讯录并触发 TA 的欢迎回复；整个链路复用既有 accept/reject 流程，无需额外操作",
    ],
  },
  {
    version: "1.4.0",
