...
export const DEFAULT_CHAT_BILINGUAL_PROMPT = [
  ...
  "- 如果内容本来就是普通话，则不要添加 |译文",
  "- 粤语等方言也属于需要翻译的情况：原文保留方言写法（如“我而家好开心”），译文用普通话（“我现在很开心”）",
...
export const DEFAULT_GROUP_CHAT_BILINGUAL_PROMPT = [
  ...
  "要求：",
  "- **普通话正常输出**：如果该条发言是普通话，直接正常输出，不要添加译文",
  "- **非普通话翻译格式要求**：如果该条发言使用非普通话语言（包括粤语等中文方言、外语），则该条发言内容必须使用“原文|对应的简体中文译文”的格式输出，必须在原文和译文之间用|分割；粤语等方言也按此处理，如“我而家好开心|我现在很开心”",
